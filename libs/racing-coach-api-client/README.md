...
```python
from racing_coach_server_client.models import MyDataModel
from racing_coach_server_client.api.my_tag import get_my_data_model
from racing_coach_server_client.types import Response
...
1. Any endpoint which did not have a tag will be in `racing_coach_server_client.api.default`
